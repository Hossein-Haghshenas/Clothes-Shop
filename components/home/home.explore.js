    ...
    <>
      <Container className="my-16 mx-8 sm:mx-2 gap-40 lg:gap-20 md:gap-10 sm:gap-4" flex justifyCenter>
        <section className="w-[30rem]">
          <Image className="md:h-[23rem]" src={exploreSectionImage} alt="new collections" />
        </section>
        <section className="flex flex-col gap-4 mt-16">
          <h1 className="text-[40px] lg:text-[30px] md:text-[25px] sm:text-[19px] sm:w-15 font-semibold">
            Explore Our New <br /> Collection
          </h1>
          <p className="w-full sm:text-[14px]">
